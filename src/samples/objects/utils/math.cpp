...
glm::vec3 Math::reflectVector(const glm::vec3 &v, const glm::vec3 &normal) {
    return v - 2.0f * glm::dot(v, normal) * normal;
}

bool Math::checkBoxVsBoxAABB(const glm::vec3 &boxPos, const glm::vec3 &boxScale, const glm::vec3 &otherPos, const glm::vec3 &otherScale) {
